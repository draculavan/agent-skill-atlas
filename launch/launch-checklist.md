...
- [x] Privacy document
- [x] Customization document
- [x] Demo skills and demo atlas
...
- GitHub users interested in `agent-skills`
- Codex Skills users
- Cursor / Claude power users with local skill libraries
...
> It scans metadata, not private skill bodies.
